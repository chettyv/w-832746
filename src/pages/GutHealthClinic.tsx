...
const PetProject = () => {
  return (
    <ProjectPageLayout
      title="Gut Health Clinic"
      subtitle="Specialized digestive health assessment and treatment"
    ...
    >
      ...
      <h2 className="text-3xl font-bold mb-6">Why Visit Our Gut Health Clinic?</h2>
      
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        <p>
          Our Gut Health Clinic provides specialized care for digestive health issues. We offer 
          comprehensive evaluation, personalized treatment plans, and ongoing support to help 
          manage digestive conditions and maintain optimal gut health.
        </p>
      </div>
        ...
        <Card className="flex flex-col h-full border-t-4 border-t-amber-700 hover:shadow-lg transition-shadow">
          ...
          <CardContent className="flex-grow">
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <div className="mr-2 mt-1 text-amber-700">✓</div>
                <span>Basic gut assessment</span>
              </li>
              <li className="flex items-start">
                <div className="mr-2 mt-1 text-amber-700">✓</div>
                <span>Dietary review</span>
              </li>
              <li className="flex items-start">
                <div className="mr-2 mt-1 text-amber-700">✓</div>
        ...
        <Card className="flex flex-col h-full border-t-4 border-t-gray-400 hover:shadow-lg transition-shadow">
          ...
          <CardContent className="flex-grow">
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <div className="mr-2 mt-1 text-gray-500">✓</div>
                <span>Detailed gut analysis</span>
              </li>
              <li className="flex items-start">
                <div className="mr-2 mt-1 text-gray-500">✓</div>
